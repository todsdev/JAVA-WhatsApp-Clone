...
public class RegisterGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab = findViewById(R.id.fab_confirmgroup);
        ...
        //FLOATING ACTION BUTTON SALVAR GRUPO
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String nameGroup = editGroupName.getText().toString();

                //ADICIONAR O USUÁRIO LOGADO A LISTA DO GRUPO
                listSelectedMembers.add(UserFirebase.getDataLoggedUser());

                //PASSANDO LISTA DE MEMBROS PARA O GROUP
