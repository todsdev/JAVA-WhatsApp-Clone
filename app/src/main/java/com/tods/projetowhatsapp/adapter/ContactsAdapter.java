...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.MyViewHolder> {
    ...
    public List<User> recoverContacts(){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemList = LayoutInflater.from
                (parent.getContext()).inflate(R.layout.adapter_recyclerunit, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (user.getPhoto() != null){
            ...
            if (header){
                holder.photo.setImageResource(R.drawable.icon_group);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            email = itemView.findViewById(R.id.editSubtitle);
        }
    }
}
